				...
				<tr>
					<td colspan="6">
						<div id="delete" class="msgActionButtons" style="float:right;"
							...
							<?php echo Html::img('/plugins/Message/img/action_delete.png', $language->restore); ?>
							<br/>
							<span><?php echo $language->delete;?></span>
						</div>
						<div id="restore" class="msgActionButtons" style="float:right;"
							onclick="document.getElementById('restore').innerHTML += '<input type=&quot;hidden&quot; name=&quot;form_message_action[restore]&quot; />';
								document.getElementById('form_message_action').submit();">
							<?php echo Html::img('/plugins/Message/img/action_restore.png', $language->deletePermanently); ?>
							<br/>
