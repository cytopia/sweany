...
class Bbcode
{
	public static function parse($text, $allowedTags = array('smilies', 'text', 'url', 'img', 'code', 'quote'))
	{
		...
		{
			$str = str_replace(':)', '<img src="/img/forum/smiley/smile.png" />', $str);
			$str = str_replace(':-)', '<img src="/img/forum/smiley/smile.png" />', $str);
			$str = str_replace(':D', '<img src="/img/forum/smiley/grin.png" />', $str);
			$str = str_replace(':d', '<img src="/img/forum/smiley/grin.png" />', $str);

			$str = str_replace(':(', '<img src="/img/forum/smiley/unhappy.png" />', $str);
			$str = str_replace(':-(', '<img src="/img/forum/smiley/unhappy.png" />', $str);

			$str = str_replace(':p', '<img src="/img/forum/smiley/tongue.png" />', $str);
			$str = str_replace(':-p', '<img src="/img/forum/smiley/tongue.png" />', $str);

			$str = str_replace(':confuse:', '<img src="/img/forum/smiley/confuse.png" />', $str);
			$str = str_replace(':cool:', '<img src="/img/forum/smiley/cool.png" />', $str);
			$str = str_replace(':cry:', '<img src="/img/forum/smiley/cry.png" />', $str);
			$str = str_replace(':red:', '<img src="/img/forum/smiley/red.png" />', $str);
			$str = str_replace(':evilgrin:', '<img src="/img/forum/smiley/evilgrin.png" />', $str);
			$str = str_replace(':surprise:', '<img src="/img/forum/smiley/surprise.png" />', $str);
			$str = str_replace(':yell:', '<img src="/img/forum/smiley/yell.png" />', $str);
			$str = str_replace(':mad:', '<img src="/img/forum/smiley/mad.png" />', $str);
			$str = str_replace(':roll:', '<img src="/img/forum/smiley/roll.png" />', $str);
		}
