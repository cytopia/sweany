...
class Url extends CoreTemplate
{
	...
	public static function initialize()
	{
		...
		// check if a backend or frontend request is made
		if ( isset($params[0]) && $params[0] == $GLOBALS['BACKEND_URL_PATH'] )
		{
			self::$backend = true;
			unset($params[0]);	// as it was the backend url path
		}
	...
	{
		return isset(self::$urlParams[1]) ? self::$urlParams[1] : NULL;
	}
