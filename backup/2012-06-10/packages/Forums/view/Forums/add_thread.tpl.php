...
<?php if (!$user->isLoggedIn()):?>
	...
	<p>Um einen Beitrag zu erstellen musst du dich erst <?php echo $html->l('hier einloggen', $userLoginCtl,$userLoginMethod);?> oder <?php echo $html->l('kostenlos registrieren', $userRegisterCtl,$userRegisterMethod);?></p>
<?php else: ?>
