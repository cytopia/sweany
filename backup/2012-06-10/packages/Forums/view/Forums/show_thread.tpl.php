	...
	<tbody>
		<tr>
			<td style="width:150px;">
				<span class="threadUsername"><?php echo ($thread['fk_user_id']>0) ? $html->l($thread['username'], $userProfileCtl, $userProfileMethod, array($thread['fk_user_id'])) : 'anonymous'; ?></span>
				<br/><br/>
				...
				<div>
					<div style="font-size:11px;">
						<a href="/<?php echo $userMessageToCtl.'/'.$userMessageToMethod.'/'.$thread['fk_user_id'];?>" title="private Nachricht an <?php echo $thread['username']; ?> schreiben">
...
<?php foreach ($posts as $post): ?>
	...
	<table class="forum">
		...
		<tbody>
			<tr>
				<td style="width:150px;">
					<span class="threadUsername"><?php echo ($post['fk_user_id']>0) ? $html->l($post['username'], $userProfileCtl, $userProfileMethod, array($post['fk_user_id'])) : 'anonymous'; ?></span>
					<br/><br/>
					<div style="font-size:11px;">
...
<?php elseif (!Users::isLoggedIn()):?>
	...
	<p>Um eine Antwort zu schreiben musst du dich erst <?php echo $html->l('hier einloggen', $userLoginCtl,$userLoginMethod);?> oder <?php echo $html->l('kostenlos registrieren', $userRegisterCtl,$userRegisterMethod);?></p>
