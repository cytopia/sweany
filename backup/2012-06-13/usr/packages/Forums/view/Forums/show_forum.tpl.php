		...
		<?php foreach ($threads as $thread): ?>
			<?php
				if ( $thread['count_posts'] > 0 )
				{
					...
					$last_user_link	= ($thread['last_post_user_id'] > 0) ? $html->l($last_user, $GLOBALS['DEFAULT_PROFILE_SHOW_CTL'], $GLOBALS['DEFAULT_PROFILE_SHOW_METHOD'], array($thread['last_post_user_id'])) : $last_user;
				}
				else
				{
					$last_date		= '';
			...
			<tr>
				...
				<td style="width:120px;">
					<?php echo ($thread['fk_user_id']>0) ? $html->l($thread['username'], $GLOBALS['DEFAULT_PROFILE_SHOW_CTL'], $GLOBALS['DEFAULT_PROFILE_SHOW_METHOD'], array($thread['fk_user_id'])) : 'anonymous'; ?><br/>
