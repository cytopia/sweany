		...
		<tr>
			...
			<td style="width:100px;">
				...
				<?php if ($thread['last_post_id']): ?>
					...
					von <?php echo Html::l($thread['last_post_username'], $userProfileCtl, $userProfileMethod, array($thread['last_post_user_id'])); ?>
				<?php else: ?>
					<?php echo getFormattedDate($thread['created']); ?> <span style="color:gray"><?php echo getFormattedTime($thread['created']);?></span><br/>
					von <?php echo Html::l($thread['username'], $userProfileCtl, $userProfileMethod, array($thread['fk_user_id'])); ?>
				<?php endif; ?>
				</div>
			</td>
