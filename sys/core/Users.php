...
class Users extends CoreTemplate
{
	...
	{
		return MySql::fetchField(self::$tbl_users, 'id', sprintf("`email` = '%s'", mysql_real_escape_string($email)));
	}
	public static function getIdByResetPasswordKey($reset_password_key)
	{
		return MySql::fetchField(self::$tbl_users, 'id', sprintf("`reset_password_key` = '%s'", mysql_real_escape_string($reset_password_key)));
	}
	...
	public static function setResetPasswordKey($user_id)
	{
		...
		return MySql::updateRow(self::$tbl_users, array('reset_password_key' => $key), $user_id);
	}
	...
	{
		return MySql::updateRow(self::$tbl_users, array('reset_password_key' => ''), $user_id);
	}
