...
<link href="/sweany/calendar/css/calendar.css" rel="stylesheet" type="text/css" />
...
<div id="calendar-page">
    <div id="calendar-header" align="center">
        <?php if($dp && !$auto_hide){ ?>
        <div align="<?php echo($rtl ? "left" : "right"); ?>" class="closeme"><a href="javascript:closeMe();"><img src="/img/calendar/close.jpg" border="0" /></a></div>
        <?php } ?>
    ...
    <div id="calendar-container">
        ...
        <div id="calendar-footer">
          <div class="btn">
			...
			?><a href="javascript:move('<?php echo(str_pad($previous_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($previous_year);?>');"><img src="/sweany/calendar/img/btn_<?php echo($rtl ? "next" : "previous"); ?>.png" width="16" height="16" border="0" alt="Zur&uuml;ck" title="Zur&uuml;ck" /></a>
			<?php
            }else echo("&nbsp;");
            ?>
            </div>
            ...
            ?><a href="javascript:move('<?php echo(str_pad($next_month, 2, "0", STR_PAD_LEFT));?>', '<?php echo($next_year);?>');"><img src="/sweany/calendar/img/btn_<?php echo($rtl ? "previous" : "next"); ?>.png" width="16" height="16" border="0" alt="Vor" title="Vor" /></a>
            <?php
            }else echo("&nbsp;");
            ?>
            </div>
            <div style="margin-left: 30px; margin-right: 30px;" align="center">
            	<a href="javascript:today();" class="txt">Heute</a>
                <?php
				/*if($sld>0 && $slm>0 && $sly>0){
